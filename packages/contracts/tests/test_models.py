...
def test_messaging_topology_constants():
    ...
    assert DIAGRAM_DLX_EXCHANGE_NAME == "hackathon.dlx"
    assert DEFAULT_DIAGRAM_DLQ_QUEUE_NAME == "diagram.analysis.dlq"
    assert DIAGRAM_DLQ_ROUTING_KEY == "diagram.analysis.dlq"
