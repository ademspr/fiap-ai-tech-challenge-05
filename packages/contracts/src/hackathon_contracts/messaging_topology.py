...
# Dead-letter: main queue must set x-dead-letter-* to these; DLQ is bound to DLX.
DIAGRAM_DLX_EXCHANGE_NAME = "hackathon.dlx"
DEFAULT_DIAGRAM_DLQ_QUEUE_NAME = "diagram.analysis.dlq"
DIAGRAM_DLQ_ROUTING_KEY = "diagram.analysis.dlq"
