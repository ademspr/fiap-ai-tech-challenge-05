...
from hackathon_api.infrastructure.adapters.minio_file_storage import MinioFileStorageAdapter
...
_file_storage = MinioFileStorageAdapter(
    minio_client_singleton(), settings.minio_bucket
)
